...
fp = open('/work2/05608/tg849075/app_ed/datasets/stampede2/bcast/kt1_st1.csv','r')
fpw = open('/work2/05608/tg849075/app_ed/datasets/stampede2/bcast/kt1_st1-cut--%d-%d--%d-%d--%d-%d.csv'%(cut_m[0],cut_m[1],cut_n[0],cut_n[1],cut_k[0],cut_k[1]),'w')
lines = fp.readlines()
fpw.write(lines[0])
for line in lines[1:]:
    x = line.split(',')
